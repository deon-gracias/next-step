...
const AUDIT_STRUCTURE = [
  ...
  },
  {
    ...
    items: [
      ...
      { prompt: "Verify that the surety bond is uploaded into RFMS and that is adequate to cover the total funds listed in the trial balance run for today?", guidance: "Review surety bond documentation.", fixedSample: 0, possiblePoints: 0 },
